...
export const SUBJECT_SEEDS: SubjectSeed[] = [
  ...
  subjectBlueprint(
    ...
    'Build wellness awareness, exercise safety, and sustainable health habits.',
    'Trophy',
    '#F97316',
    [
      {
        title: 'Fitness and Wellness Basics',
        summary:
          'Fitness and wellness support physical health, energy, and daily performance.',
        content:
          'Physical fitness includes strength, endurance, flexibility, and body awareness. Wellness also includes rest, nutrition, stress management, and healthy routines. Students in tourism benefit from fitness because many tourism jobs involve long hours, movement, and guest-facing energy.',
      },
      {
        title: 'Exercise Safety and Sportsmanship',
        summary:
          'Safe movement and respectful behavior matter in all physical activities.',
        content:
          'Exercise safety includes warm-up, proper form, hydration, appropriate intensity, and cool-down. Sportsmanship means respect, fairness, self-control, and teamwork. These values help students participate confidently and responsibly in physical activities.',
      },
      {
        title: 'Healthy Habits and Fitness Planning',
        summary:
          'Simple routines make fitness more realistic and sustainable over time.',
        content:
          'Health habits include sleep, balanced meals, hydration, movement, and recovery. A basic fitness plan sets goals, selects activities, manages frequency, and tracks progress. Students should aim for consistency rather than perfection when building healthy routines.',
      },
    ],
    [
      {
        question: 'Physical fitness includes:',
        options: [
          'Strength and endurance',
          'Only travel marketing',
          'Only airport codes',
          'Only conference setup',
        ],
        answer: 'A',
        explanation:
          'Fitness includes physical qualities such as strength, endurance, and flexibility.',
      },
      {
        question: 'Why is warm-up important?',
        options: [
          'It prepares the body for exercise',
          'It replaces hydration',
          'It ends a workout',
          'It removes sportsmanship',
        ],
        answer: 'A',
        explanation: 'Warm-up helps prepare muscles and reduce injury risk.',
      },
      {
        question: 'Sportsmanship includes:',
        options: [
        ...
        answer: 'A',
        explanation:
          'Sportsmanship is built on respect, fairness, and self-control.',
      },
      {
        question: 'Wellness includes:',
        options: [
          'Rest and stress management',
          'Only ticketing',
          'Only destination branding',
          'Only event registration',
        ],
        answer: 'A',
        explanation:
          'Wellness extends beyond exercise to rest, stress, and healthy living.',
      },
      {
        question: 'Hydration matters during exercise because it:',
        options: [
          'Supports safe body function',
          'Always decreases performance',
          'Is only for athletes',
          'Replaces recovery',
        ],
        answer: 'A',
        explanation:
          'Hydration helps maintain performance and safety during activity.',
      },
      {
        question: 'A cool-down helps the body:',
        options: [
          'Transition after exercise',
          'Skip recovery',
          'Increase injury risk',
          'Avoid breathing control',
        ],
        answer: 'A',
        explanation:
          'Cool-down helps the body recover and gradually return to rest.',
      },
      {
        question: 'A fitness plan should focus on:',
        options: [
          'Consistency and realistic goals',
          'Perfection only',
          'No tracking',
          'One intense day only',
        ],
        answer: 'A',
        explanation:
          'Sustainable plans are realistic, consistent, and measurable.',
      },
      {
        question: 'Healthy habits include:',
        options: [
          'Sleep and balanced meals',
          'Only gaming all night',
          'Ignoring recovery',
          'Skipping hydration',
        ],
        answer: 'A',
        explanation:
          'Healthy habits include rest, nutrition, hydration, and balanced activity.',
      },
      {
        question: 'Proper form is important because it:',
        options: [
          'Helps safety and effectiveness',
          'Makes exercise less useful',
          'Only matters in tourism',
          'Removes discipline',
        ],
        answer: 'A',
        explanation:
          'Proper form helps prevent injury and improves exercise quality.',
      },
      {
        question:
          'Tourism students benefit from fitness because many tourism roles:',
        options: [
          'Need energy and physical readiness',
          'Require no movement',
        ...
        answer: 'A',
        explanation:
          'Many tourism roles are active and benefit from fitness and stamina.',
      },
    ],
    [
      {
        front: 'Physical Fitness',
        back: 'The body’s ability to perform activity effectively and safely.',
        category: 'Key Term',
      },
      {
        front: 'Wellness',
        back: 'Overall health that includes physical, mental, and lifestyle balance.',
        category: 'Key Term',
      },
      {
        front: 'Warm-up',
        back: 'Preparation before exercise to ready the body.',
        category: 'Exercise Safety',
      },
      {
        front: 'Cool-down',
        back: 'Gentle activity after exercise to support recovery.',
        category: 'Exercise Safety',
      },
      {
        front: 'Hydration',
        back: 'Maintaining enough fluids for healthy body function.',
        category: 'Health Habit',
      },
      {
        front: 'Sportsmanship',
        back: 'Respectful and fair behavior in physical activity.',
        category: 'Concept',
      },
      {
        front: 'Recovery',
        back: 'Rest and restoration after physical effort.',
        category: 'Concept',
      },
      {
        front: 'Fitness Plan',
        back: 'A structured routine for exercise goals and progress.',
        category: 'Concept',
      },
      {
        front: 'Proper Form',
        back: 'Correct movement technique during exercise.',
        category: 'Review',
      },
      {
        front: 'Consistency',
        back: 'Maintaining healthy routines over time.',
        category: 'Review',
      },
    ],
  ),

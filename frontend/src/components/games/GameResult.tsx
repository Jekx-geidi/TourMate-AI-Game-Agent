...
const MOODS: Record<ResultMood, { icon: LucideIcon; gradient: string }> = {
  ...
  great: { icon: Star, gradient: 'from-cyan-400 via-cyan-500 to-cyan-500' },
...
export function GameResult({
  ...
  return (
    <div className="rounded-2xl border border-cyan-200 dark:border-cyan-800/60 bg-gradient-to-br from-cyan-50 dark:from-cyan-950/40 to-cyan-50 dark:to-cyan-950/30 p-6 text-center">
